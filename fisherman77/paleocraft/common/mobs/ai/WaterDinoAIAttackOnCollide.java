...
public class WaterDinoAIAttackOnCollide extends EntityAIBase
{
    World worldObj;
    ...
    public WaterDinoAIAttackOnCollide(EntityCreature par1EntityCreature, Class par2Class, double par3, boolean par5)
    {
        this(par1EntityCreature, par3, par5);
        this.classTarget = par2Class;
    }

    public WaterDinoAIAttackOnCollide(EntityCreature par1EntityCreature, double par2, boolean par4)
    {
    ...
    public boolean shouldExecute()
    {
        ...
        else if (entitylivingbase.posY > 63)
        {
            return false;
        }
        else
