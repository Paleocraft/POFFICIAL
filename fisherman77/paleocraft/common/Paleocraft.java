...
//Mod Basics
//==========
@Mod(modid="Paleocraft",name="Paleocraft",version="1.6.4 Cambrian 1.4.4")
...
paleodesertsand = new Blockpaleodesertsand().setBlockName("paleodesertsand"); GameRegistry.registerBlock(paleodesertsand, paleodesertsand.getUnlocalizedName().substring(5)).setHardness(0.5F).setStepSound(Block.soundTypeSand);
paleoplainsdirt = new Blockpaleoplainsdirt().setBlockName("paleoplainsdirt"); GameRegistry.registerBlock(paleoplainsdirt, paleoplainsdirt.getUnlocalizedName().substring(5)).setHardness(0.5F).setStepSound(Block.soundTypeGravel);
...
paleoforestgrass = new Blockpaleoforestgrass().setBlockName("paleoforestgrass"); GameRegistry.registerBlock(paleoforestgrass, paleoforestgrass.getUnlocalizedName().substring(5)).setHardness(0.5F).setStepSound(Block.soundTypeGrass);
Fossilore = new BlockFossilore().setBlockName("fossilore"); GameRegistry.registerBlock(Fossilore, Fossilore.getUnlocalizedName().substring(5)).setHardness(0.5F).setStepSound(Block.soundTypeStone);
//Biomes
	Paleoplains = new BiomeGenPaleoplains(PaleocraftConfigCore.biomepaleoplainsID).setColor(2900485).setBiomeName("PaleoPlains").setTemperatureRainfall(1F, 0.5F).BiomeGenBase.Height(0.1F, 0.2F);
	Paleotempforest = new BiomeGenPaleotempforest(PaleocraftConfigCore.biomepaleotempforestID).setColor(2900485).setBiomeName("PaleoTempForest").setTemperatureRainfall(1F, 0.5F).setMinMaxHeight(0.1F, 0.2F);
	Paleodesert = new BiomeGenPaleodesert(PaleocraftConfigCore.biomepaleodesertID).setColor(2900485).setBiomeName("Paleodesert").setTemperatureRainfall(1F, 0.5F).setMinMaxHeight(0.1F, 0.2F);
	...
	//Items
	fossil = new ItemFossil(PaleocraftConfigCore.itemFossilID).setUnlocalizedName("Fossil");
	
	TroodonEgg = new ItemTroodonEgg(PaleocraftConfigCore.itemTroodonEggID).setUnlocalizedName("DinoEgg");
	DromaeosaurusEgg = new ItemDromaeosaurusEgg(PaleocraftConfigCore.itemDromaeosaurusEggID).setUnlocalizedName("DinoEgg2");
	//Blocks
	seaweed = new Blockseaweed(PaleocraftConfigCore.blockSeaweedID).setUnlocalizedName("seaweed").setStepSound(soundGrassFootstep);
	portalTrigger = new portalTriggerPaleocraft(PaleocraftConfigCore.blockportaltriggerID, 1).setUnlocalizedName("portaltrigger");
	PaleocraftPortal = new BlockPortalPaleocraft(PaleocraftConfigCore.blockPaleoPortalID).setUnlocalizedName("paleocraftportal");
	//PaleocraftPortal = new BlockPortalPaleocraft(251).setUnlocalizedName("paleocraftportal");
	treesapling1 = new Blocktree1sapling(PaleocraftConfigCore.blocktreesapling1ID, 0).setUnlocalizedName("tree1").setStepSound(Block.soundGrassFootstep);
treesapling2 = new Blocktree2sapling(PaleocraftConfigCore.blocktreesapling2ID, 0).setUnlocalizedName("tree2").setStepSound(Block.soundGrassFootstep);}
...
//DONT NEED GAMEREGISTERY ANYMORE!!!!!
//Game registery 
...
//Language registery
 LanguageRegistry.addName(PaleocraftPortal, "Paleocraft Portal");
                ...
                LanguageRegistry.addName(Fossilore, "Fossil");
...
//MOBS
	...
	EntityRegistry.registerModEntity(EntityGhost.class, "Bladeking68", 1, this, 80, 3, true);
	...
	//Troodon
		...
		//LanguageRegistry.instance().addStringLocalization("entity.Quetzalcoatlus.name", "Quetzalcoatlus");
//
		LanguageRegistry.instance().addStringLocalization("entity.Paleocraft.Bladeking68.name", "Bladeking68");
		EntityRegistry.addSpawn(EntityGhost.class, 1, 4, 4, EnumCreatureType.monster, BiomeGenBase.plains);
}
