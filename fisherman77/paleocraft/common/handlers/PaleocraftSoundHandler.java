...
public class PaleocraftSoundHandler
{
    ...
    public void onSound(SoundLoadEvent event)
    {
        ...
        //Quetzalcoatlus
            event.manager.addSound("paleocraft:Quetz1.ogg"); 
            event.manager.addSound("paleocraft:Quetz2.ogg"); 
            event.manager.addSound("paleocraft:QuetzHurt.ogg"); 
            event.manager.addSound("paleocraft:MedCarnDeath.ogg"); 
        } 
        catch (Exception e)
        {
