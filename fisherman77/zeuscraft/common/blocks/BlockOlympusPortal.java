...
import fisherman77.zeuscraft.common.olympus.TeleporterOlympus;
...
public class BlockOlympusPortal extends BlockPortal
{
 public BlockOlympusPortal(int id, int texture)
 {
  super(id, texture);
 ...
 public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity)
 {
  if (par5Entity.ridingEntity == null && par5Entity.riddenByEntity == null)
  {
   if (par5Entity instanceof EntityPlayerMP)
   {
    ...
    if (par5Entity.dimension != Zeuscraft.Olympus)
    {
     thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, Zeuscraft.Olympus, new TeleporterOlympus(thePlayer.mcServer.worldServerForDimension(Zeuscraft.Olympus)));
    }
    else
    {
     thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, 0, new TeleporterOlympus(thePlayer.mcServer.worldServerForDimension(0)));
    }
   }
  }
 }
