...
public class TeleporterOlympus extends Teleporter
{
 ...
 private final List field_85190_d = new ArrayList();
  ...
  public TeleporterOlympus(WorldServer par1WorldServer)
 {
    ...
    for (int var14 = -2; var14 <= 2; ++var14)
   {
    for (int var15 = -2; var15 <= 2; ++var15)
    {
     for (int var16 = -1; var16 < 3; ++var16)
     {
      ...
      this.field_85192_a.setBlockWithNotify(var17, var18, var19, var20 ? Zeuscraft.CBronzeBlock.blockID : 0);
     }
    }
   }
 ...
 public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
 {
  ...
  else
  {
   for (var48 = var15 - var9; var48 <= var15 + var9; ++var48)
   {
     ...
     for (int var23 = var16 - var9; var23 <= var16 + var9; ++var23)
    {
     ...
     {
      if (this.field_85192_a.getBlockId(var48, var26, var23) == Zeuscraft.OlympusPortal.blockID)
      {
       while (this.field_85192_a.getBlockId(var48, var26 - 1, var23) == Zeuscraft.OlympusPortal.blockID)
       {
        --var26;
       }
   ...
   if (var10 >= 0.0D)
  {
   ...
   int var50 = -1;
    ...
    if (this.field_85192_a.getBlockId(var12 - 1, var13, var14) == Zeuscraft.OlympusPortal.blockID)
   {
    var50 = 2;
   }
    ...
    if (this.field_85192_a.getBlockId(var12 + 1, var13, var14) == Zeuscraft.OlympusPortal.blockID)
   {
    ...
    if (this.field_85192_a.getBlockId(var12, var13, var14 - 1) == Zeuscraft.OlympusPortal.blockID)
   {
    var50 = 3;
   }
    ...
    for (var19 = -1; var19 <= 1; ++var19)
   {
    for (var20 = 1; var20 < 3; ++var20)
    {
     for (var21 = -1; var21 < 3; ++var21)
     {
      ...
      var33 = var21 < 0;
      this.field_85192_a.setBlockWithNotify(var22, var23, var24, var33 ? Zeuscraft.CBronzeBlock.blockID : 0);
     }
    }
   }
  }
   ...
   for (var19 = 0; var19 < 4; ++var19)
  {
    ...
    for (var20 = 0; var20 < 4; ++var20)
   {
    for (var21 = -1; var21 < 4; ++var21)
    {
     ...
     this.field_85192_a.setBlockWithNotify(var22, var23, var24, var33 ? Zeuscraft.CBronzeBlock.blockID : Zeuscraft.OlympusPortal.blockID);
    }
   }
