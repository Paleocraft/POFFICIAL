...
public class EntityHarpie extends EntityFlying implements IMob
{
    ...
    public EntityHarpie(World par1World)
    {
        super(par1World);
        this.texture = "/Zeuscraft/Mobs/Harpie/harpie.png";
    ...
    public boolean attackEntityFrom(DamageSource par1DamageSource, int par2)
    {
        ...
        else if ("fireball".equals(par1DamageSource.getDamageType()) && par1DamageSource.getEntity() instanceof EntityPlayer)
        {
            ...
            ((EntityPlayer)par1DamageSource.getEntity()).triggerAchievement(Zeuscraft.BirdHunting);
            return true;
        }
        else
        {
