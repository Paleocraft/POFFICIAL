...
public class ItemCBronzeSword extends Item
{
private int weaponDamage;
private final EnumToolMaterial toolMaterial;

public ItemCBronzeSword(int ID, EnumToolMaterial material, int tex, String name)
{
...
{
return Zeuscraft.CBronzeIngot.itemID == par2ItemStack.itemID ? true : super.getIsRepairable(par1ItemStack, par2ItemStack);
}
}