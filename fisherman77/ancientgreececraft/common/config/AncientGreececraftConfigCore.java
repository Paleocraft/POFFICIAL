package fisherman77.ancientgreececraft.common.config;

import net.minecraftforge.common.Configuration;
import net.minecraftforge.common.Property;
import cpw.mods.fml.common.event.FMLPreInitializationEvent;

public class AncientGreececraftConfigCore {

//Items
public static int itemGobletID;
public static int itemGrapesID;
...
itemGobletID = config.getItem("Celestial Bronze Ingot ID", 1401).getInt();
itemGrapesID = config.getItem("Golden Bow ID", 1402).getInt();
