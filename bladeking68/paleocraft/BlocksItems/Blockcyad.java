...
public class Blockcyad extends BlockBush
{
   ...
   /* public void registerIcons(IIconRegister iconRegister)
    ...
    @SideOnly(Side.CLIENT)
	 ...
	 {
	 return par1 == 1 ? this.iconnestTop : (par1 == 0 ? this.iconnestbottom : this.blockIcon);
	 }
	   
	 @SideOnly(Side.CLIENT)
	    public void registerBlockIcons(IIconRegister p_149651_1_)
	    {
		 this.blockIcon = p_149651_1_.registerIcon(Paleocraft.MODID + ":" + "Cycad");
		 this.iconnestTop = p_149651_1_.registerIcon(Paleocraft.MODID + ":" + "Cycad_2");
		 this.iconnestbottom = p_149651_1_.registerIcon(Paleocraft.MODID + ":" + "Cycad");
	    }
