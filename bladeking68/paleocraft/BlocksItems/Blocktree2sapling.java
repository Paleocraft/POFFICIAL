...
public class Blocktree2sapling extends BlockFlower
{
/** change the name to your sapling name **/
public static final String[] WOOD_TYPES = new String[] {"PaleocraftTree2"};
public Blocktree2sapling(int i, int j)
{
super(i);
float var3 = 0.4F;
...
object = new WorldGenPaleocraftTree2(true, 10 + par5Random.nextInt(20), 3, 3, false);
flag = true;
break;
}
}
...
i1 = 0;
/** Change this to your WorldGenNAMETree **/
object = new WorldGenPaleocraftTree2(true, 4 + par5Random.nextInt(7), 3, 3, false);
}
}
else
{
/** Change this to your WorldGenNAMETree **/
object = new WorldGenPaleocraftTree2(true); // Changed //
...
return par1 == Block.grass.blockID || par1 == fisherman77.paleocraft.common.Paleocraft.paleoforestgrass.blockID || par1 == Block.tilledField.blockID;
}
