...
public class ItemDromaeosaurusEgg extends Item
{
       ...
       public ItemDromaeosaurusEgg()
       {
             
           // this.setCreativeTab(fisherman77.paleocraft.common.Paleocraft.PaleocraftBlocks);
       }
      
       public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer, EntityPlayer par1EntityPlayer)
       {
     ...
     /*  EntityDromaeosaurus entitydromaeosaurus = new EntityDromaeosaurus (par2World);
       entitydromaeosaurus.setPosition(par3EntityPlayer.posX, par3EntityPlayer.posY + 1, par3EntityPlayer.posZ);
       par2World.spawnEntityInWorld(entitydromaeosaurus);*/
       }
