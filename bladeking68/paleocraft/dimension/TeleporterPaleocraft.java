...
this.field_85192_a.setBlock(var17, var18, var19, var20 ? Block.cobblestoneMossy.blockID : 0);
}
}
}
...
{
if (this.field_85192_a.getBlockId(var48, var26, var23) == PaleocraftDimension.PaleocraftPortal.blockID)
{
while (this.field_85192_a.getBlockId(var48, var26 - 1, var23) == PaleocraftDimension.PaleocraftPortal.blockID)
{
--var26;
}
...
int var50 = -1;
if (this.field_85192_a.getBlockId(var12 - 1, var13, var14) == PaleocraftDimension.PaleocraftPortal.blockID)
{
var50 = 2;
}
if (this.field_85192_a.getBlockId(var12 + 1, var13, var14) == PaleocraftDimension.PaleocraftPortal.blockID)
...
if (this.field_85192_a.getBlockId(var12, var13, var14 - 1) == PaleocraftDimension.PaleocraftPortal.blockID)
{
var50 = 3;
}
if (this.field_85192_a.getBlockId(var12, var13, var14 + 1) == PaleocraftDimension.PaleocraftPortal.blockID)
...
public boolean func_85189_a(Entity par1Entity)
{
byte var2 = 16;
double var3 = -1.0D;
...
var33 = var21 < 0;
this.field_85192_a.setBlock(var22, var23, var24, var33 ? Block.cobblestoneMossy.blockID : 0);
}
}
}
}
...
{
this.field_85192_a.scheduledUpdatesAreImmediate = true;
...
this.field_85192_a.setBlock(var22, var23, var24, var33 ? Block.cobblestoneMossy.blockID : PaleocraftDimension.PaleocraftPortal.blockID);
}
}
this.field_85192_a.scheduledUpdatesAreImmediate = false;
for (var20 = 0; var20 < 4; ++var20)
{
for (var21 = -1; var21 < 4; ++var21)
{
