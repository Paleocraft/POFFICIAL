...
public class TeleporterPaleocraft extends Teleporter
{
...
public TeleporterPaleocraft(WorldServer par1WorldServer) {
...
this.worldServer.setBlockWithNotify(var17, var18, var19, var20 ? Block.cobblestoneMossy.blockID : 0);
}
}
}
...
PortalPositionPaleocraft var20 = (PortalPositionPaleocraft) this.longHashMap.getValueByKey(var17);
var10 = 0.0D;
var12 = var20.posX;
var13 = var20.posY;
var14 = var20.posZ;
...
if (this.worldServer.getBlockId(var48, var26, var23) == Paleocraft.PaleocraftPortal.blockID) {
while (this.worldServer.getBlockId(var48, var26 - 1, var23) == Paleocraft.PaleocraftPortal.blockID) {
--var26;
}
...
if (var10 >= 0.0D) {
if (var19) {
this.longHashMap.add(var17, new PortalPositionPaleocraft(this, var12, var13, var14, this.worldServer.getTotalWorldTime()));
...
if (this.worldServer.getBlockId(var12 - 1, var13, var14) == Paleocraft.PaleocraftPortal.blockID) {
var50 = 2;
}
...
if (this.worldServer.getBlockId(var12, var13, var14 - 1) == Paleocraft.PaleocraftPortal.blockID) {
var50 = 3;
}
...
var33 = var21 < 0;
this.worldServer.setBlockWithNotify(var22, var23, var24, var33 ? Block.cobblestoneMossy.blockID : 0);
}
}
}
}
...
this.worldServer.setBlockWithNotify(var22, var23, var24, var33 ? Block.cobblestoneMossy.blockID : Paleocraft.PaleocraftPortal.blockID);
}
}
...
PortalPositionPaleocraft var7 = (PortalPositionPaleocraft) this.longHashMap.getValueByKey(var6.longValue());
