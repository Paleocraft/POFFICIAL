...
for (i1 = -1; i1 <= 3; ++i1)
{
         ...
         else if (j1 != 0 && j1 != fisherman77.paleocraft.common.Paleocraft.portalTrigger.blockID)
         {
         return false;
         }
         }
...
for (i1 = 0; i1 < 3; ++i1)
{
         par1World.setBlock(par2 + b0 * l, par3 + i1, par4 + b1 * l, fisherman77.paleocraft.common.Paleocraft.PaleocraftPortal.blockID, 0, 2);
}
}
return true;
}
...
if ((par5Entity.ridingEntity == null) && (par5Entity.riddenByEntity == null) && ((par5Entity instanceof EntityPlayerMP)))
         ...
         else if (thePlayer.dimension != fisherman77.paleocraft.common.Paleocraft.PaleocraftDimension)
         {
                 thePlayer.timeUntilPortal = 10;
                 thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, fisherman77.paleocraft.common.Paleocraft.PaleocraftDimension, new TeleporterPaleocraft(thePlayer.mcServer.worldServerForDimension(fisherman77.paleocraft.common.Paleocraft.PaleocraftDimension)));
         }
         else {
                 thePlayer.timeUntilPortal = 10;
