...
public class WorldChunkManagerPaleocraft extends WorldChunkManager
{
...
this.myBiomesToSpawnIn.add(fisherman77.paleocraft.common.Paleocraft.Paleoswamp);
}

public WorldChunkManagerPaleocraft(long seed, WorldType worldtype)
{
this();
// i changed this to my GenLayerTutorial
GenLayer[] agenlayer = GenLayerPaleocraft.makeTheWorld(seed);
this.myGenBiomes = agenlayer[0];
this.myBiomeIndexLayer = agenlayer[1];
}

public WorldChunkManagerPaleocraft(World world)
{
