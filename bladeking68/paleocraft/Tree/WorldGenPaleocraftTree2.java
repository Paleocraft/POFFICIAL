...
public class WorldGenPaleocraftTree2 extends WorldGenerator implements IWorldGenerator
{
...
public WorldGenPaleocraftTree2(boolean par1)
{
this(par1, 8, 0, 0, false);
}
public WorldGenPaleocraftTree2(boolean par1, int par2, int par3, int par4, boolean par5)
{
super(par1);
...
(new WorldGenPaleocraftTree2(false, 8, 0, 0, false)).generate(world, random, xCoord, yCoord, zCoord);
}
}
}
