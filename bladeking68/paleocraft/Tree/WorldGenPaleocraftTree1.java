...
public class WorldGenPaleocraftTree1 extends WorldGenerator implements IWorldGenerator
{
...
public WorldGenPaleocraftTree1(boolean par1)
{
this(par1, 8, 0, 0, false);
}
public WorldGenPaleocraftTree1(boolean par1, int par2, int par3, int par4, boolean par5)
{
super(par1);
...
for (int l1 = par3 - b0; l1 <= par3 + b0 && flag; ++l1)
{
         ...
         if (k1 != 0 &&
                 ...
                 k1 != fisherman77.paleocraft.common.Paleocraft.paleoforestgrass.blockID && //CUSTOM GRASS
                 k1 != Block.dirt.blockID && //CUSTOM DIRT
...
if (isSoil && par4 < 256 - l - 1)
{
         ...
         {
         this.setBlockAndMetadata(par1World, par3, par4 + j1, par5, Block.wood.blockID, 0);
...
(new WorldGenPaleocraftTree1(false, 8, 0, 0, false)).generate(world, random, xCoord, yCoord, zCoord);
}
}
}
